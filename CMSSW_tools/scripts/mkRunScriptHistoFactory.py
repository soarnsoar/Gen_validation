...
f.write('CreateCmsRunPythonBasedOnConfig.py --config $CMSSW_BASE/src/Gen_validation/CMSSW_tools/scripts/HistoConfigForReweight.py --rootfile '+inputrootfile+' --seed '+seed+'\n')
