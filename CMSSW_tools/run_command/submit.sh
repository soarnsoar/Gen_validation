...
for vmg in ${ARR_VMG[@]};do
    ...
    mkGENevt.py --fragment /cms/ldap_home/jhchoi/gridvalidation/mg265_validation/fragments/Hadronizer_TuneCP5_13TeV_MLM_5f_max4j_qCut19_LHE_pythia8_cff.py --nevent ${NEVENT} --startseed ${i_seed} --endseed ${f_seed} --tag GENEVT_${vmg}_dyellell01234j_5f_LO_MLM_pdfwgt_T --gridpack /cms/ldap_home/jhchoi/gridvalidation/mg265_validation/gridpacks/cms1/${vmg}/dyellell01234j_5f_LO_MLM_pdfwgt_T_slc6_amd64_gcc630_CMSSW_9_3_8_tarball.tar.xz
