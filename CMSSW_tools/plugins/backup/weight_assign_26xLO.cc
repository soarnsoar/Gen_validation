...
///LO26x///
LO26xInfo.push_back(weightinfo("1001", "247000", "scale_variation_muR_1.0_muF_1.0", 1.0, 1.0));
LO26xInfo.push_back(weightinfo("1006", "247000", "scale_variation_muR_2.0_muF_1.0", 2.0, 1.0));
LO26xInfo.push_back(weightinfo("1011", "247000", "scale_variation_muR_0.5_muF_1.0", 0.5, 1.0));
LO26xInfo.push_back(weightinfo("1016", "247000", "scale_variation_muR_1.0_muF_2.0", 1.0, 2.0));
LO26xInfo.push_back(weightinfo("1021", "247000", "scale_variation_muR_2.0_muF_2.0", 2.0, 2.0));
LO26xInfo.push_back(weightinfo("1026", "247000", "scale_variation_muR_0.5_muF_2.0", 0.5, 2.0));
LO26xInfo.push_back(weightinfo("1031", "247000", "scale_variation_muR_1.0_muF_0.5", 1.0, 0.5));
LO26xInfo.push_back(weightinfo("1036", "247000", "scale_variation_muR_2.0_muF_0.5", 2.0, 0.5));
LO26xInfo.push_back(weightinfo("1041", "247000", "scale_variation_muR_0.5_muF_0.5", 0.5, 0.5));
